...
public class ClientVersion : IComparable<ClientVersion>, IComparer<ClientVersion>, IEquatable<ClientVersion>
{
    ...
    public ClientVersion(string fmt)
    {
        ...
        try
        {
            ...
            Major = fmt.AsSpan()[..br1].ToInt32();
            Minor = fmt.AsSpan(br1 + 1, br2 - br1 - 1).ToInt32();
            Revision = fmt.AsSpan(br2 + 1, br3 - br2 - 1).ToInt32();
            ...
            if (br3 < fmt.Length)
            {
                ...
                {
                    Patch = fmt.AsSpan(br3 + 1, fmt.Length - br3 - 1).ToInt32();
                }
            }
